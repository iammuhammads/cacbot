import { RegistrationIntakeService } from "../dist/services/ai/intake-service.js";
import { env } from "../dist/config/env.js";
import { EMPTY_REGISTRATION_DATA } from "../dist/types/domain.js";
import { randomUUID } from "node:crypto";

async function test() {
  console.log("--- AI ROUTING TEST (JS) ---");
  ...
  try {
    const decision = await intake.processTurn(mockSession, "tell me a joke please");
